...
Admin.create!(
	[
		email: ENV.fetch("ADMIN_MAIL"),
		password: ENV.fetch("ADMIN_PASS"),
		password_confirmation: ENV.fetch("ADMIN_PASS_CONFI")
	]
)
...
Item.create!(
	[
	   {item_category_id: 1,
		...
		description: "メイン一品の8品コース。飲料はビールの銘柄は選べません",
		unit_price: 18000,
		...
		{item_category_id: 2,
			...
			client_plan_id: 1,
			name: '【プランS】シンプル装花セット', 
			description: "メインテーブル（ボリューム3割）、各テーブル、ブーケ×1、ブートニアのセット",
			unit_price: 150000,
		...
		{item_category_id: 4,
			...
			description: "50種類のドレス・ドレスからそれぞれ1セットずつ",
			unit_price: 200000,
		...
		{item_category_id: 5,
			...
			description: "当日カメラマンが100カットほど撮影。撮影データを後日Web上でご送付",
			unit_price: 150000,
